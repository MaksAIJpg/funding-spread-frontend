  ...
  return (
    <main style={{ padding: 20, background: 'black', color: 'white', minHeight: '100vh' }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        <thead>
          <tr>
            <th style={{ borderBottom: '1px solid white' }}>Пара</th>
            <th style={{ borderBottom: '1px solid white' }}>Gate.io</th>
            <th style={{ borderBottom: '1px solid white' }}>MEXC</th>
            <th style={{ borderBottom: '1px solid white' }}>Спред</th>
          </tr>
        </thead>
        <tbody>
          {filtered.map((item, i) => (
